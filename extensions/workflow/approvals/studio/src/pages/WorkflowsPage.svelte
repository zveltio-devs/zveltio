    ...
    <div class="modal-box w-11/12 max-w-2xl">
      ...
      <div class="grid grid-cols-2 gap-4 mb-4">
        <div class="form-control col-span-2">
          ...
          <input type="text" bind:value={form.name} placeholder="e.g. Document Approval" class="input input-bordered" />
        </div>

        <div class="form-control col-span-2">
          <label class="label"><span class="label-text">Collection</span></label>
          <select bind:value={form.collection} class="select select-bordered">
        ...
        <div class="form-control">
          ...
          <input type="text" bind:value={form.trigger_field} placeholder="status" class="input input-bordered input-sm" />
        </div>

        <div class="form-control">
          <label class="label"><span class="label-text">Trigger value</span></label>
          <input type="text" bind:value={form.trigger_value} placeholder="pending_approval" class="input input-bordered input-sm" />
        </div>
      </div>
                ...
                <div class="flex gap-2 items-start">
                  <div class="flex-1 space-y-2">
                    ...
                    <div class="flex gap-2">
                      <select bind:value={step.approver_role} class="select select-bordered select-sm flex-1">
