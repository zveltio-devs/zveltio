    ...
    <div class="modal-box">
      ...
      <div class="space-y-3">
        <div class="form-control">
          ...
          <input type="text" bind:value={form.name} placeholder="e.g. Notify on new order" class="input input-bordered" />
        </div>

        <div class="form-control">
          <label class="label"><span class="label-text">Trigger</span></label>
          <select bind:value={form.trigger.type} class="select select-bordered">
        ...
        {#if form.trigger.type === 'data_event'}
          <div class="grid grid-cols-2 gap-2">
            <div class="form-control">
              ...
              <input type="text" bind:value={form.trigger.collection} placeholder="orders" class="input input-bordered input-sm" />
            </div>
            <div class="form-control">
              <label class="label"><span class="label-text">Event</span></label>
              <select bind:value={form.trigger.event} class="select select-bordered select-sm">
        ...
        {:else if form.trigger.type === 'cron'}
          <div class="form-control">
            ...
            <input type="text" bind:value={form.trigger.cron} placeholder="0 9 * * 1-5" class="input input-bordered input-sm font-mono" />
          </div>
        {/if}
      </div>
