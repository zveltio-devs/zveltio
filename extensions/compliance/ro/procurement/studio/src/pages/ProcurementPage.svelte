    ...
    <div class="modal-box w-11/12 max-w-3xl">
      ...
      <div class="grid grid-cols-2 gap-3 mb-4">
        <div class="form-control">
          ...
          <input type="text" bind:value={orderForm.number} placeholder="CA-2026-001" class="input input-bordered input-sm font-mono" />
        </div>
        <div class="form-control">
          <label class="label"><span class="label-text">Data</span></label>
          <input type="date" bind:value={orderForm.date} class="input input-bordered input-sm" />
        </div>
        <div class="form-control">
          <label class="label"><span class="label-text">Furnizor</span></label>
          <input type="text" bind:value={orderForm.supplier_name} class="input input-bordered input-sm" />
        </div>
        <div class="form-control">
          <label class="label"><span class="label-text">CUI Furnizor</span></label>
          <input type="text" bind:value={orderForm.supplier_cui} class="input input-bordered input-sm font-mono" />
        </div>
        <div class="form-control col-span-2">
          <label class="label"><span class="label-text">Descriere obiect achizitie</span></label>
          <input type="text" bind:value={orderForm.description} class="input input-bordered input-sm" />
        </div>
      </div>
        ...
        <table class="table table-xs">
          ...
          <tbody>
            {#each orderForm.items as item, i}
              <tr>
                <td><input type="text" bind:value={item.description} class="input input-bordered input-xs w-36" /></td>
                <td><input type="number" bind:value={item.quantity} oninput={() => recalcItem(item)} class="input input-bordered input-xs w-16" /></td>
                <td><input type="text" bind:value={item.unit} class="input input-bordered input-xs w-12" /></td>
                <td><input type="number" step="0.01" bind:value={item.unit_price} oninput={() => recalcItem(item)} class="input input-bordered input-xs w-24" /></td>
    ...
    <div class="modal-box">
      ...
      <div class="space-y-3">
        <div class="form-control">
          ...
          <input type="text" bind:value={supplierForm.name} class="input input-bordered" />
        </div>
        <div class="form-control">
          <label class="label"><span class="label-text">CUI</span></label>
          <input type="text" bind:value={supplierForm.cui} class="input input-bordered font-mono" />
        </div>
        <div class="grid grid-cols-2 gap-3">
          <div class="form-control">
            <label class="label"><span class="label-text">Judet</span></label>
            <input type="text" bind:value={supplierForm.county} class="input input-bordered input-sm" />
          </div>
          <div class="form-control">
            <label class="label"><span class="label-text">Categorie</span></label>
            <input type="text" bind:value={supplierForm.category} class="input input-bordered input-sm" />
          </div>
        </div>
        <div class="form-control">
          <label class="label"><span class="label-text">Email contact</span></label>
          <input type="email" bind:value={supplierForm.contact_email} class="input input-bordered input-sm" />
        </div>
      </div>
      <div class="modal-action">
