        ...
        <div class="w-72 border-l border-base-300 flex flex-col bg-base-100">
          ...
          <div class="p-3 flex-1 flex flex-col">
            ...
            <textarea
              ...
              class="textarea textarea-bordered textarea-sm font-mono flex-1 resize-none text-xs"
              placeholder="{}"
            ></textarea>
            <button
    ...
    <div class="modal-box">
      ...
      <div class="space-y-3">
        <div class="form-control">
          ...
          <input type="text" bind:value={form.name} placeholder="my-function" class="input input-bordered font-mono" />
        ...
        <div class="form-control">
          ...
          <input type="text" bind:value={form.display_name} placeholder="My Function" class="input input-bordered" />
        </div>
        <div class="form-control">
          <label class="label"><span class="label-text">HTTP method</span></label>
          <select bind:value={form.http_method} class="select select-bordered">
