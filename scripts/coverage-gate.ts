#!/usr/bin/env bun
/**
 * Coverage ratchet — hardening plan item H-02.
 *
...
if (update) {
  ...
  const baseline: CoverageBaseline = {
    ...
    note: 'Engine line coverage ratchet. Gated buckets may not drop more than maxDropPct below `measured`. See hardening plan item H-02.',
