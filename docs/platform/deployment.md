# 🚀 Zveltio Deployment Guide

Complete guide for deploying Zveltio to production.
...
Zveltio can be deployed using Docker Compose for most use cases. For enterprise deployments, Kubernetes or other orchestration platforms can be used.
...
| -------------- | -------- | ----- | ---------- | -------- |
| **Minimum**    | 1 core   | 2GB   | 20GB SSD   | 100 Mbps |
| **Small**      | 2 cores  | 4GB   | 50GB SSD   | 100 Mbps |
| **Medium**     | 4 cores  | 8GB   | 200GB SSD  | 1 Gbps   |
...
# Database (PostgreSQL via PgDog pooler)
DATABASE_URL=postgresql://zeltio:PASSWORD@pgdog:6432/zeltio_prod
