...
**Complete overview of the Zveltio platform** — a self-hosted Business OS built with Bun, designed for enterprises and public institutions. Not just a BaaS: data API, CRM, automation, compliance, AI, and real-time in a single binary.
...
**Zveltio** is a self-hosted **Business OS** built with Bun. It provides everything a business needs to run on its own infrastructure:
