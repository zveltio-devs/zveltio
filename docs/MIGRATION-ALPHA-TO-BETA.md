...
> Use the latest beta (currently **3.0.0-beta.7**). See [ALPHA-TRACK-EOL.md](./ALPHA-TRACK-EOL.md).
...
6. **Update SDK dependencies**
   ```bash
   bun add @zveltio/sdk@3.0.0-beta.7
   bun add @zveltio/react@3.0.0-beta.7   # if using React SDK
   bun add @zveltio/vue@3.0.0-beta.7     # if using Vue SDK
   ```
