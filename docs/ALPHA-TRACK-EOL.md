...
|----------------|--------|
| **Nothing installed yet** | Install beta only: `curl -fsSL https://get.zveltio.com/install.sh \| bash` or `zveltio update --version 3.0.0-beta.9` |
...
| **Pinned to a specific alpha in CI** | Unpin; move CI to `3.0.0-beta.9` (or `@latest` beta from [get.zveltio.com/latest.json](https://get.zveltio.com/latest.json)) |

```bash
# Recommended upgrade path
zveltio update --version 3.0.0-beta.9
...
**Upgrade:** `zveltio update --version 3.0.0-beta.9` (or latest beta from
