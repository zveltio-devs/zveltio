...
| Marketplace public policy doc | ✅ DONE (alpha.129) | `docs/extensions/marketplace-policy.md` — v1.0 effective beta.1. §0 maps each policy claim to enforcing code; §8 operator runbook; §9 lists what's still human (review team / SLA / appeals) |
