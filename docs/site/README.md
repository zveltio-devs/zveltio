...
- [GraphQL API](GRAPHQL.md) - Auto-generated GraphQL with queries, mutations, and persisted queries (developer/graphql extension)
...
├── GRAPHQL.md          # GraphQL API (developer/graphql extension)
...
- [GitHub Repository](https://github.com/zveltio-devs/zveltio)
- [Issues](https://github.com/zveltio-devs/zveltio/issues)
- [Discussions](https://github.com/zveltio-devs/zveltio/discussions)
