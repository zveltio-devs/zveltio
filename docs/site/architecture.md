...
Zveltio is a self-hosted **Business OS** — a distributed platform designed for enterprises and public institutions that goes beyond a traditional BaaS. The system follows a **modular monolith architecture** with clear separation of concerns.
...
│   │   └── migrations/             # 54 SQL migrations (000–053)
│   ├── routes/
...
│   │   ├── graphql.ts              # GraphQL bridge (routes handled by developer/graphql extension)
...
| ----------------- | ----------- | --------------------------- |
| **Runtime**       | Bun 1.3.13  | JavaScript runtime          |
...
| Pool          | PgDog           | 0.1.33  | Multi-threaded connection pooler, SCRAM-SHA-256 native |
...
| GraphQL       | graphql         | 16.x    | Auto-generated GraphQL API (developer/graphql extension) |
| Batching      | dataloader      | 2.x     | N+1 query prevention (used by GraphQL extension) |
...
| PgDog      | ghcr.io/pgdogdev/pgdog   | 6432       |
