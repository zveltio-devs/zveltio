...
const KEYS: Record<string, { en: string; ro: string }> = {
  ...
  'finance.banking.empty.transactions': {
    en: 'No transactions yet.',
    ro: 'Nicio tranzacție încă.',
  },
  'finance.banking.empty.unreconciled': {
    en: 'No unreconciled transactions.',
    ro: 'Nicio tranzacție nereconciliată.',
  },
  'finance.banking.section.unreconciled': {
    en: 'Unreconciled transactions',
    ro: 'Tranzacții nereconciliate',
  },
  'finance.banking.section.openInvoices': {
    en: 'Open invoices (sent)',
    ro: 'Facturi deschise (trimise)',
  },
  ...
  'workflow.checklists.empty.listHint': {
    en: 'Create your first checklist to get started.',
    ro: 'Creează primul checklist pentru a începe.',
  },
  'workflow.approvals.tab.requests': { en: 'Requests', ro: 'Cereri' },
  'workflow.approvals.tab.workflows': { en: 'Workflows', ro: 'Fluxuri' },
  'workflow.approvals.empty.requests': {
    en: 'No approval requests found.',
    ro: 'Nicio cerere de aprobare.',
  },
  'workflow.approvals.empty.workflows': {
    en: 'No workflows configured.',
    ro: 'Niciun flux configurat.',
  },
...
patch('finance/subscriptions/studio/pages/+page.svelte', [
  [
    '<Plus size={14} /> New plan</button>',
    "<Plus size={14} /> {m['finance.subscriptions.btn.newPlan']()}</button>",
  ],
  ...
  [
    ...
    '<th class="text-right">{m[\'finance.subscriptions.col.mrr\']()}</th>',
  ],
