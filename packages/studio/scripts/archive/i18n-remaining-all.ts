...
const KEYS: [string, string, string][] = [
  ...
  [
    'billing.empty.noSubscription',
    'No active subscription. Choose a plan below.',
    'Niciun abonament activ. Alege un plan mai jos.',
  ],
  ...
  [
    ...
    'Indexuri căutare full-text și semantică',
  ],
  ...
  [
    'auth.ldap.placeholder.username',
    'Use {{username}} as placeholder for the login value',
    'Folosește {{username}} ca placeholder pentru login',
  ],
  ['auth.saml.title', 'SAML SSO', 'SAML SSO'],
  [
    'auth.saml.subtitle',
    'Single sign-on with identity provider',
    'Single sign-on cu furnizor identitate',
  ],
  ...
  [
    'sms.placeholder.body',
    'Body (use {{name}} for interpolation)',
    'Conținut (folosește {{name}} pentru interpolare)',
  ],
  ...
  [
    'content.media.empty.folder',
    'Empty folder. Drag files here or click Upload.',
    'Folder gol. Trage fișiere sau apasă Încarcă.',
  ],
  ['developer.validation.title', 'Data Validation', 'Validare date'],
  [
    'developer.validation.subtitle',
    'Field-level validation with AI assistance',
    'Validare la nivel de câmp cu asistență AI',
  ],
  ...
  [
    'content.documents.empty',
    'No documents yet. Generate one from a template.',
    'Nicio document încă. Generează dintr-un șablon.',
  ],
  ...
  [
    'content.documents.empty.noVariables',
    'No variables needed for this template.',
    'Nu sunt variabile pentru acest șablon.',
  ],
  ...
  [
    'content.document-templates.bodyHint',
    'Body — use {{var}} for substitution',
    'Conținut — folosește {{var}} pentru substituție',
  ],
  ...
  [
    'data.export.filterHint',
    'Filter (Zveltio query, optional)',
    'Filtru (query Zveltio, opțional)',
  ],
  ...
  [
    'data.import.dropHint',
    'Drag a CSV / JSON / NDJSON file, or click to browse',
    'Trage CSV / JSON / NDJSON sau click pentru browse',
  ],
  [
    'data.import.upsertHint',
  ...
  [
    'geospatial.postgis.clusterHint',
    'Use POST /ext/geospatial/postgis/cluster — returns clusters with centroid and counts.',
    'Folosește POST /ext/geospatial/postgis/cluster — returnează clustere cu centroid.',
  ],
  ...
  [
    'hr.payroll.selectPeriod',
    'Select a period to view payroll entries.',
    'Selectează o perioadă pentru înregistrări salarizare.',
  ],
  ...
  [
    'integrations.api-connector.empty.connections',
    'No external API connections yet.',
    'Nicio conexiune API externă.',
  ],
  ...
  [
    'projects.helpdesk.empty.select',
    'Select a ticket to view the conversation.',
    'Selectează un tichet pentru conversație.',
  ],
  ...
  [
    'workflow.checklists.empty.items',
    'No items yet. Add some below.',
    'Niciun element. Adaugă mai jos.',
  ],
  ...
  [
    'ai.subtitle',
    'Providers, chat, search, SQL, and schema tools',
    'Furnizori, chat, căutare, SQL și scheme',
  ],
];
...
patch('auth/ldap/studio/pages/+page.svelte', [
  ...
  [
    'Use {{username}} as placeholder for the login value',
    "{m['auth.ldap.placeholder.username']()}",
  ],
]);
...
patch('search/studio/pages/+page.svelte', [
  [
    ...
    '<h1 class="text-xl font-semibold">{m[\'search.title\']()}</h1>',
  ],
...
wrapSimple(
  ...
  'workflow.checklists.title',
  'workflow.checklists.subtitle',
  'space-y-6',
);
