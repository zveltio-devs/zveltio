...
/**
 * `/developer/edge-functions` is a second, diverged implementation of `/edge-functions`.
 *
 ...
 * `/edge-functions`, which makes that one canonical and this one reachable solely
 * by an old bookmark.
 *
...
export function load() {
  redirect(301, `${base}/edge-functions`);
}
