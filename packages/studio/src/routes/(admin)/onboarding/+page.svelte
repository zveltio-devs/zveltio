      ...
      <div class="card-body gap-6">
        ...
        {#if step === 'welcome'}
          <div class="text-center space-y-3">
            ...
            <p class="text-base-content/60">{m['onboarding.welcomeDesc1']()}<br />{m['onboarding.welcomeDesc2']()}</p>
          </div>
          ...
          <div>
            <div class="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p class="text-sm text-base-content/50">{m['onboarding.colDesc']()}</p>
              </div>
            </div>
              ...
              <div class="space-y-3">
                ...
                <div class="form-control">
                  <label class="label" for="col-name">
                    <span class="label-text">{m['onboarding.slug']()} <span class="text-base-content/40">{m['onboarding.autoGenerated']()}</span></span>
                  </label>
                  <input
                    id="col-name"
          ...
          <div>
            <div class="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p class="text-sm text-base-content/50">{m['onboarding.keyDesc']()}</p>
              </div>
            </div>
          ...
          <div>
            <div class="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p class="text-sm text-base-content/50">{m['onboarding.testDesc']()}</p>
              </div>
            </div>
            ...
            <div class="bg-base-200 rounded-lg p-3 font-mono text-xs mb-3 space-y-1">
              ...
              <p class="text-base-content/50">X-API-Key: {apiKey ? apiKey.slice(0, 20) + '…' : m['onboarding.yourKey']()}</p>
            </div>
          ...
          <div>
            <div class="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p class="text-sm text-base-content/50">{m['onboarding.webhookDesc']()}</p>
              </div>
            </div>
            ...
            <div class="form-control">
              ...
              <p class="text-xs text-base-content/40 mt-1">{m['onboarding.leaveEmptySkip']()}</p>
            </div>
          </div>
        ...
        {:else if step === 'done'}
          <div class="text-center space-y-4 py-2">
            ...
            <p class="text-base-content/60">{m['onboarding.doneDesc']()}</p>
