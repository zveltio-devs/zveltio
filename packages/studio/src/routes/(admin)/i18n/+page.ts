...
/**
 * `/i18n` is a second, diverged implementation of `/translations`.
 *
 ...
 * `/translations`, which makes that one canonical and this one reachable solely
 * by an old bookmark.
 *
...
export function load() {
  redirect(301, `${base}/translations`);
}
