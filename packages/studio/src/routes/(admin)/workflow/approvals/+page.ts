...
/**
 * `/workflow/approvals` is a second, diverged implementation of `/approvals`.
 *
 ...
 * `/approvals`, which makes that one canonical and this one reachable solely
 * by an old bookmark.
 *
