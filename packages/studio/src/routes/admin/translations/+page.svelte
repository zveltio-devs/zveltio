      ...
      <div class="card-body gap-3">
        ...
        <div class="grid grid-cols-3 gap-3">
          <div class="form-control">
            ...
            <input id="lc_code" type="text" bind:value={newLocale.code} placeholder="ro" class="input input-bordered input-sm" />
          </div>
          <div class="form-control">
            <label class="label" for="lc_name"><span class="label-text">Name</span></label>
            <input id="lc_name" type="text" bind:value={newLocale.name} placeholder="Română" class="input input-bordered input-sm" />
          </div>
      ...
      <div class="card-body gap-3">
        ...
        <div class="grid grid-cols-2 gap-3">
          <div class="form-control">
            ...
            <input id="key_key" type="text" bind:value={newKey.key} placeholder="auth.login.title" class="input input-bordered input-sm font-mono" />
          </div>
          <div class="form-control">
            <label class="label" for="key_ctx"><span class="label-text">Context</span></label>
            <input id="key_ctx" type="text" bind:value={newKey.context} placeholder="ui / email / content" class="input input-bordered input-sm" />
          </div>
          <div class="form-control col-span-2">
            <label class="label" for="key_def"><span class="label-text">Default value (English fallback)</span></label>
            <input id="key_def" type="text" bind:value={newKey.default_value} placeholder="Login to your account" class="input input-bordered input-sm" />
          </div>
        </div>
        <div class="flex gap-2">
