  ...
  <div class="modal modal-open">
    <div class="modal-box">
      ...
      <div class="form-control mb-3">
        ...
        <textarea id="page-desc" class="textarea textarea-bordered" placeholder="Brief description for SEO" bind:value={newPage.description} rows={2}></textarea>
      </div>

      <div class="form-control mb-3">
        <label class="label" for="page-layout"><span class="label-text">Layout</span></label>
        <select id="page-layout" class="select select-bordered" bind:value={newPage.layout}>
