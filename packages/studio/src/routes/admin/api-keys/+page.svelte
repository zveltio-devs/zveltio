    ...
    <div class="modal-box">
      ...
      <div class="space-y-4">
        <div class="form-control">
          ...
          <input type="text" bind:value={form.name} placeholder="Production API Key" class="input input-bordered" />
        </div>
        <div class="form-control">
          <label class="label"><span class="label-text">Rate limit (requests/hour)</span></label>
          <input type="number" bind:value={form.rate_limit} min="1" class="input input-bordered" />
        </div>
        <div class="form-control">
          <label class="label">
          ...
          <input type="date" bind:value={form.expires_at} class="input input-bordered" />
        </div>
