    ...
    <div class="modal-box">
      ...
      <div class="space-y-3">
        <div class="form-control">
          ...
          <input type="text" bind:value={newBranchName} placeholder="e.g., add-user-settings" class="input input-bordered" />
        </div>
        <div class="form-control">
          <label class="label"><span class="label-text">Description</span></label>
          <textarea bind:value={newBranchDescription} rows="3" placeholder="Describe the purpose..." class="textarea textarea-bordered"></textarea>
        </div>
      </div>
