<script lang="ts">
/**
 * Error boundary for the portal zone. Renders inside the portal shell so the
 * visitor stays oriented (navigation visible) instead of dropping into the
 * root error page.
 *
 * This was a verbatim copy of the admin boundary: it told a portal visitor
    ...
    <div class="card bg-base-100 border border-base-300">
      <div class="card-body items-center text-center gap-3 p-8">
        ...
        <p class="text-sm text-base-content/65 max-w-md">
          {page.status === 404
            ? 'That URL does not match any portal page.'
        ...
        <div class="flex flex-wrap gap-2 mt-2">
          ...
          <button class="btn btn-ghost btn-sm gap-2" onclick={() => goto(`${base}/portal-client`)}>
