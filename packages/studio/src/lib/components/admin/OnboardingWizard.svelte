    ...
    <div class="p-6">
      {#if step === 1}
        ...
        <div class="form-control mb-3">
          ...
          <input id="company-name" type="text" class="input input-bordered" placeholder="e.g., My Organization" bind:value={companyName} />
        </div>
        ...
        <div class="form-control mb-6">
          ...
          <div class="flex items-center gap-3">
            ...
            <input type="text" class="input input-bordered input-sm flex-1" bind:value={primaryColor} />
          </div>
        </div>
      ...
      {:else if step === 2}
        ...
        {#if !skipCollection}
          <div class="form-control mb-3">
            ...
            <input id="coll-name" type="text" class="input input-bordered" placeholder="e.g., articles, employees"
          ...
          <div class="form-control mb-6">
            ...
            <input id="coll-display" type="text" class="input input-bordered" placeholder="e.g., Articles, Employees" bind:value={collectionDisplay} />
          </div>
        {/if}
