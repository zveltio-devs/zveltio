...
-- is_system    — true for platform-owned collections (not CRM — CRM is an extension).
...
COMMENT ON COLUMN zvd_collections.is_system     IS 'true for platform-owned collections (CRM tables are extension-owned)';
